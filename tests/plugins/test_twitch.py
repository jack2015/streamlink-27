...
class TestTwitchAPIAccessToken:
    ...
    def plugin(self, request):
        ...
        Twitch.bind(session, "tests.plugins.test_twitch")
        yield Twitch("https://twitch.tv/channelname")
    ...
    def test_plugin_options(self, plugin, mock, exp_headers, exp_variables):
    ...
    def test_live_success(self, plugin, mock, assert_live):
    ...
    def test_live_failure(self, plugin, mock, assert_live):
        with pytest.raises(NoStreamsError):
            plugin._access_token(True, "channelname")
    ...
    def test_vod_success(self, plugin, mock, assert_vod):
    ...
    def test_vod_failure(self, plugin, mock, assert_vod):
        with pytest.raises(NoStreamsError):
    ...
    def test_auth_failure(self, caplog, plugin, mock, assert_live):
